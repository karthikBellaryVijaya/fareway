"""
Django settings for team3project project.
...
SECRET_KEY = 'ar=q4^e83yja!s1q86p#fo#s@h)5w**e!^!g^rqs8ks1fldg0_'
...
ROOT_URLCONF = 'team3project.urls'
...
WSGI_APPLICATION = 'team3project.wsgi.application'
